...
module.exports = {
  ...
  prompts: [{
    ...
    name: 'wantRoutes',
    default: true,
    message: 'Do you want to add container routes?',
  }],
  actions: (data) => {
    ...
    if (data.wantRoutes) {
      ...
      actions.push({
        type: 'modify',
        path: '../../app/routes.js',
        pattern: /(\/\/ import-module-end)/g,
        template: trimTemplateFile('importRoutes.hbs'),
      });
      ...
      actions.push({
        ...
        path: '../../app/routes.js',
        pattern: /(\s{\n\s{0,}path: '\*',)/g,
        template: trimTemplateFile('injectRoutes.hbs'),
      });
    }
